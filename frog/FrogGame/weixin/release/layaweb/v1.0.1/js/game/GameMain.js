...
(function (game) {
    ...
    var GameMain = /** @class */ (function (_super) {
        ...
        GameMain.prototype.frogActionOver = function (actionName) {
            ...
            if (actionName == game.Frog.ACTIONS.stand) { //静止
            }
            else if (actionName == game.Frog.ACTIONS.flyUp) { //起跳
            }
            else if (actionName == game.Frog.ACTIONS.jump) { //起飞
            }
            else if (actionName == game.Frog.ACTIONS.upToDown) { //上升变下降
            }
            else if (actionName == game.Frog.ACTIONS.flyDown) { //下降
            }
            else if (actionName == game.Frog.ACTIONS.landing) { //落地
            }
            else if (actionName == game.Frog.ACTIONS.blast) { //爆炸
                this.gameOver();
            }
        };
        return GameMain;
